...
export function register(tree: SymbolsTree, context: vscode.ExtensionContext): void {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand('better-navigation.findReferences', () => findLocations('References', 'vscode.executeReferenceProvider')),
		vscode.commands.registerCommand('better-navigation.findImplementations', () => findLocations('Implementations', 'vscode.executeImplementationProvider')),
		// --- legacy name
		vscode.commands.registerCommand('better-navigation.find', (...args: any[]) => vscode.commands.executeCommand('better-navigation.findReferences', ...args)),
		vscode.commands.registerCommand('better-navigation.removeReferenceItem', removeReferenceItem),
		vscode.commands.registerCommand('better-navigation.copy', copyCommand),
		vscode.commands.registerCommand('better-navigation.copyAll', copyAllCommand),
		vscode.commands.registerCommand('better-navigation.copyPath', copyPathCommand),
	);


	// --- better-navigation.preferredLocation setting

	let showReferencesDisposable: vscode.Disposable | undefined;
	const config = 'better-navigation.preferredLocation';
