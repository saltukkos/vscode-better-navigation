...
export function register(tree: SymbolsTree, context: vscode.ExtensionContext): void {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand('better-navigation.showTypeHierarchy', showTypeHierarchy),
		vscode.commands.registerCommand('better-navigation.showSupertypes', (item: TypeItem | vscode.Location | unknown) => setTypeHierarchyDirection(TypeHierarchyDirection.Supertypes, item)),
		vscode.commands.registerCommand('better-navigation.showSubtypes', (item: TypeItem | vscode.Location | unknown) => setTypeHierarchyDirection(TypeHierarchyDirection.Subtypes, item)),
		vscode.commands.registerCommand('better-navigation.removeTypeItem', removeTypeItem)
	);
}
...
class RichTypesDirection {
	...
	private static _key = 'better-navigation.typeHierarchyMode';

	private _ctxMode = new ContextKey<TypeHierarchyDirection>('better-navigation.typeHierarchyMode');
